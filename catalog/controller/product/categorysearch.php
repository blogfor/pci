...
/* Magictoolbox magiczoomplus module BEGIN */
	...
	class ControllerProductCategorysearch extends Controller {
	...
	public function index() { 
		...
		if ($category_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/categorysearch.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/product/categorysearch.tpl';
			} else {
				$this->template = 'default/template/product/categorysearch.tpl';
			}
//			
//			$this->children = array(
//				'common/column_left',
