		...
		if ($product_info) {
			...
			if ($this->config->get('config_tax')) {
				...
				$this->data['tax'] = false;
                        ...
                        $taxAmt=str_replace(",", "", trim($this->data['tax']));
                        $taxAmt=str_replace("Rs.", "", trim($taxAmt));
                        $totAmt=str_replace(",", "", trim($this->data['price']));
                        $totAmt=str_replace("Rs.", "", trim($totAmt));
                        $this->data['taxPrice']=$totAmt-$taxAmt;
