...
class ModelCatalogProduct extends Model {
	...
	public function getTotalCategoryProducts($category_id) {
		...
		*/
		$sql = "select COUNT(DISTINCT p.product_id) AS total from " . DB_PREFIX . "product_to_category p2c left join " . DB_PREFIX . "product p on p2c.product_id = p.product_id where p.status = '1' and p2c.category_id = '" . (int)$category_id . "'";
