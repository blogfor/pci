...
<script>
$(function(){
    $("#opnmnu").click(function(){
        $("#opnmnul").toggleClass("submenu__1a");
    });
	
	$("#opnmnu2").click(function(){
        $("#opnmnul2").toggleClass("submenu__2a");
    });
	
	$("#opnmnu3").click(function(){
        $("#opnmnul3, #opnmnul3a, #opnmnul3b, #opnmnul3c").toggleClass("submenu__3a");
    });
});
</script>
<style>
...
<div class="megamenu_mobile visible-xs visible-sm">
	<h2 id="opnmnu">jewelry<i></i></h2>
	<ul class="submenu__1" id="opnmnul">
		<li class="megamenu__1">
		    <a href="<?php echo $home; ?>">Home</a>
		</li>

		<li class="megamenu__2">
		    <a href="index.php?route=product/category&path=20" id="opnmnu2">Products<i></i></a>
		    
		    <ul class="submenu__2" id="opnmnul2">

				<li>
	              	<a href="index.php?route=product/category&path=34" id="opnmnu3">Bracelets<i></i></a>
					<ul class="submenu__3" id="opnmnul3">
				...
				<li>
					...
					<ul class="submenu__3" id="opnmnul3a">
				...
				<li>
					...
					<ul class="submenu__3" id="opnmnul3b">
				...
				<li>
					...
					<ul class="submenu__3" id="opnmnul3c">
