...
<?php echo $content_top; ?>
  ...
  <ul class="breadcrumb">
    ...
    <span class="page-title"><?php echo $breadcrumb['text']; ?></span>
    </a></li>
    <?php } ?>
  </ul>
        ...
        <div class="collection-scope">
          ...
          <div class="page_content">
            <div class="product-info">
              <?php if ($thumb || $images) { ?>
              <div class="left-col col-sm-6 col-lg-6">
                <?php if ($thumb) { ?>
              ...
              <?php } ?>
              <div class="right col-sm-6 col-lg-6">
                ...
                <div class="options">
                  ...
                  <?php if ($option['type'] == 'text') { ?>                  
                  <div id="option-<?php echo $option['product_option_id']; ?>" class="price-option">
                    <b><?php echo $option['name']; ?>:</b><br />
                ...
                <div class="cart">
                  <div><?php echo $text_qty; ?>
                    <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" style="margin-top: 5px;" />
                ...
                <div class="review">
                  <div><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" style="padding-top: 4px;" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
            ...
            <div id="tabs" class="htabs col-lg-12 col-sm-12">
            ...
            <?php if ($attribute_groups) { ?>
            <div id="tab-attribute" class="tab-content col-lg-12 col-sm-12">
            ...
            <div id="tab-description" class="tab-content col-lg-12 col-sm-12"><?php echo $description; ?></div>
            
            <?php if ($review_status) { ?>
            <div id="tab-review" class="tab-content col-lg-12 col-sm-12">
              <div id="review"></div>
            ...
            <?php } ?>
            <?php if ($products) { ?>
            <div id="tab-related" class="tab-content col-lg-12 col-sm-12">
