...
<div class="col-lg-12" style="background-color:#FF0000; color:#FFFFFF; font-size:16px; line-height:30px; text-align:center; padding:10px 0; z-index:9999;">
Site under construction
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 col-md-5 cls">
                            ...
                            <ul class="header_user">
                                ...
                                <a href="<?php echo $account; ?>" id="customer_login_link"><?php echo $text_logged; ?></a>
                                ...
                                <a href="<?php echo $account; ?>" id="customer_login_link">Log in</a>
        ...
        else if($_REQUEST['route']!="common/home"){

        	echo '<div class="hr1 margin-top"><!-- Divider --></div>';
