...
<!--<div class="header_currency">
	...
	<a class="btn" href="<?php echo $checkout; ?>" style="float:right; height: 40px; margin: 9px 20px 0px 0px; padding: 12px 19px; font-size: 14px; color: #777 !important; text-transform: none;">Check out</a> <!--checkout-->
    ...
    <img src="catalog/view/theme/pccindia/cdn.shopify.com/s/files/1/0691/3777/t/2/assets/logo.jpg" style="width:230px;">
     </a>
    </div>
</div>
</header>
