    ...
    <div class="container pmagn2"><!-- Container -->
        ...
        <div class="carousel-inner">
         <div class="item active">
            <img class="img-responsive" src="catalog/view/theme/pccindianew/image/wedding_ban2.jpg" alt="slider">
           
        </div><!--/ Carousel item end -->
        <div class="item">
            <img class="img-responsive" src="catalog/view/theme/pccindianew/image/B4ll1OoCEAAba9w.jpg" alt="slider">
        ...
        <a href="http://pcchandraindiaonline.com/index.php?route=product/category&amp;path=34">
        ...
        <a href="http://pcchandraindiaonline.com/collections/key-chains.html">
        <img src="catalog/view/theme/pccindianew/images/custom_showcase4_imgc74c.jpg" alt="Rings Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam."><div><h3>Astral Gems</h3>
        <p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p><span>Shop now!</span></div>
        </a>
        </div>
        ...
        <a href="http://pcchandraindiaonline.com/index.php?route=product/category&amp;path=34">
        <img src="catalog/view/theme/pccindianew/images/custom_showcase5_imgc74c.jpg" alt="Watches Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam."><div><h3>Light Jewellary</h3>
        ...
        <a href="http://pcchandraindiaonline.com/index.php?route=product/category&amp;path=20">
            ...
            <div class="projects-carousel touch-carousel">
                ...
                <div class="portfolio-item item">
                    <div class="portfolio-border">
                        ...
                        <div class="portfolio-details text-center">
                            <h4><a href="http://pcchandraindiaonline.com/index.php?route=product/category&amp;path=20">Bracelets</a></h4>
                            <p>Only kings and emperors, priests and pirates could own the jewelry. Anci...</p>
                            <p><a class="btn" href="http://pcchandraindiaonline.com/index.php?route=product/category&amp;path=20">See all</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="portfolio-item item">
                    <div class="portfolio-border">
                        ...
                        <div class="portfolio-details text-center">
                            <h4><a href="http://pcchandraindiaonline.com/index.php?route=product/category&amp;path=20">Rings</a></h4>
