<div class="collection-scope">
          ...
          <div class="page_content">
            ...
            <div class="product-list">
              ...
              <div id="P<?php echo $product['product_id'];?>"  class="wow  col-sm-4 product portfolio-item product__<?php echo $i; ?>">
                ...
                <div class="text-center" style="border: 1px solid #eeeeee;">
                  ...
                  <div class="product_img portfolio-thumb effect"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
