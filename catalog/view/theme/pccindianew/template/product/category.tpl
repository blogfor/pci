          ...
          <div class="row">
            ...
            <div id="P<?php echo $product['product_id'];?>" class="wow  col-sm-4 product product__<?php echo $i;?> portfolio-item">
              ...
              <div class="text-center product-block portfolio-border" >
                ...
                <div class="product_img portfolio-thumb effect"> <a href="<?php echo $p_url; ?>" url='<?php echo $p_url; ?>' pid="<?php echo $pid; ?>" onclick="javascript:clickonproduct(this);">
                    <?php   $date = strtotime($product['date_added']);
                            $date = strtotime("+15 day", $date);  
                            $current_date=strtotime(date());
                             if ($product['date_added']< $date)
                                echo '<img src="catalog/view/theme/pccindianew/images/new_tag.png" style="float: right; position: absolute;" />';
                ...
                <div class="product_info" style=" margin: 10px auto; ">
                  ...
                  ?>
                  <div class="cart">
                      <input type="button" value="Out of stock"  class="btn btn-cart" /> 
                      </div>
