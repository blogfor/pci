...
<?php echo $attention; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>
<?php } ?>
<?php if ($success) { ?>
...
<?php } ?>
<?php if ($error_warning) { ?>
<div class="alert alert-warning"><?php echo $error_warning; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>
<?php } ?>
  ...
  <div class="content">
    ...
    <table class=" table table-striped">
      ...
      <tr class="highlight ">
        <td style="width: 30px;"><?php if ($next == 'coupon') { ?>
  ...
  <div class="cart-module">
    ...
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <table  class="table table-striped">
        ...
        <tr>
          <td colspan="2"><input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="btn" /></td>
        </tr>
      </table>
      </div>
    ...
    <table id="total"  class="table table-striped">
      ...
      <tr>
        ...
        <div class="buttons">
            ...
            <div class="left"><a href="<?php echo $continue; ?>" class="btn"><?php echo $button_shopping; ?></a></div>
          </div>
        </td>
      </tr>
    </table>
