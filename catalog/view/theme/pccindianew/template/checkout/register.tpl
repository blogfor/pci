...
<div class="left col-md-6 col-lg-6">
...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE; padding-left:20px;">
...
<?php if ($text_agree) { ?>
<div class="buttons" >
  <div class="right" style="padding-right:20px;"><?php echo $text_agree; ?>
