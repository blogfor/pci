...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		$product_id = $this->db->getLastId();
                ...
                $gold_rate=$this->db->query("SELECT * FROM " . DB_PREFIX . "setting WHERE `group`='config' AND `key`='".$data['gold_carat']."'");
		...
		if (isset($data['product_category'])) {
			foreach ($data['product_category'] as $category_id) {
                ...
                $mancharges=$this->db->query("SELECT * FROM " . DB_PREFIX . "category WHERE category_id='".$category_id."'");
