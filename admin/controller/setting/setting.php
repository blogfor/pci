	...
	public function index() {
		...
		if (isset($this->request->post['config_google_analytics'])) {
			...
			$this->data['config_google_analytics'] = $this->config->get('config_google_analytics');
                ...
                if (isset($this->request->post['gd_15_rate'])) {
			$this->data['gd_15_rate'] = $this->request->post['gd_15_rate'];
		} else {
			$this->data['gd_15_rate'] = $this->config->get('gd_15_rate');			
		}
        
         if (isset($this->request->post['gd_18_rate'])) {
			$this->data['gd_18_rate'] = $this->request->post['gd_18_rate'];
		} else {
			$this->data['gd_18_rate'] = $this->config->get('gd_18_rate');			
		}
        
         if (isset($this->request->post['gd_20_rate'])) {
			$this->data['gd_20_rate'] = $this->request->post['gd_20_rate'];
		} else {
			$this->data['gd_20_rate'] = $this->config->get('gd_20_rate');			
		}
        
         if (isset($this->request->post['gd_22_rate'])) {
			$this->data['gd_22_rate'] = $this->request->post['gd_22_rate'];
		} else {
			$this->data['gd_22_rate'] = $this->config->get('gd_22_rate');			
		}
         if (isset($this->request->post['gd_24_rate'])) {
			$this->data['gd_24_rate'] = $this->request->post['gd_24_rate'];
		} else {
			$this->data['gd_24_rate'] = $this->config->get('gd_24_rate');			
		}
