...
class ControllerModuleCodeManager extends Controller {
    ...
    public function index() { 
        ...
        $this->document->addScript('view/javascript/'.$this->data['moduleNameSmall'].'/bootstrap/js/bootstrap.min.js');
        $this->document->addStyle('view/javascript/'.$this->data['moduleNameSmall'].'/bootstrap/css/bootstrap.min.css');
        $this->document->addStyle('view/stylesheet/'.$this->data['moduleNameSmall'].'/font-awesome/css/font-awesome.min.css');
        $this->document->addStyle('view/stylesheet/'.$this->data['moduleNameSmall'].'/'.$this->data['moduleNameSmall'].'.css');
		...
		$this->data['moduleData'] = (isset($this->data['data'][$this->data['moduleName']])) ? $this->data['data'][$this->data['moduleName']] : array();
