...
class ControllerModulecustomsearch extends Controller {
	...
	public function index() {   
		$this->language->load('module/customsearch');
		...
		$this->data['action'] = $this->url->link('module/customsearch', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['customsearch_module'])) {
			$this->data['modules'] = $this->request->post['customsearch_module'];
		} elseif ($this->config->get('customsearch_module')) { 
			$this->data['modules'] = $this->config->get('customsearch_module');
		}	
		...
		$this->template = 'module/customsearch.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
