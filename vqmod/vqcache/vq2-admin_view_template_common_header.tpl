...
<?php } ?>
<link rel="stylesheet" type="text/css" href="view/stylesheet/flat-stylesheet.css" />
...
<div id="header">
  <div class="div1">
    ...
    <?php if ($logged) { ?>
    <div class="div3"><img src="view/image/flat-image/lock.png" alt="" style="position: relative; top: 3px;" />&nbsp;<?php echo $logged; ?></div>
    <?php } ?>
  </div>
  <?php if ($logged) { ?>
  <div id="menu">
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="<?php echo $home; ?>" class="top"><img src="view/image/flat-image/dashboard-menu.png" alt="" /><?php echo $text_dashboard; ?></a></li>
      <li id="catalog"><a class="top"><img src="view/image/flat-image/catalog-menu.png" alt="" /><?php echo $text_catalog; ?></a>
        <ul>
      ...
      <li id="extension"><a class="top"><img src="view/image/flat-image/extension-menu.png" alt="" /><?php echo $text_extension; ?></a>
        <ul>
      ...
      <li id="sale"><a class="top"><img src="view/image/flat-image/sale-menu.png" alt="" /><?php echo $text_sale; ?></a>
        <ul>
      ...
      <li id="system"><a class="top"><img src="view/image/flat-image/system-menu.png" alt="" /><?php echo $text_system; ?></a>
        <ul>
      ...
      <li id="reports"><a class="top"><img src="view/image/flat-image/report-menu.png" alt="" /><?php echo $text_reports; ?></a>
        <ul>
      ...
      <li id="help"><a class="top"><img src="view/image/flat-image/help-menu.png" alt="" /><?php echo $text_help; ?></a>
        <ul>
