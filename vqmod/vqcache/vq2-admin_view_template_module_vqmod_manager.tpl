...
<div class="box">
  <div class="heading">
    <h1><img src="view/image/flat-image/module.png" alt="<?php echo $heading_title; ?>" /><?php echo $heading_title; ?></h1>
    <div class="buttons"><a onclick="location = '<?php echo $cancel; ?>';" class="button cancel"><span><?php echo $button_cancel; ?></span></a></div>
  </div>
  <div class="content">
