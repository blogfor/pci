...
$this->data['button_export'] = $this->language->get('button_export');
			$this->data['export'] = $this->url->link('catalog/product/export', 'token=' . $this->session->data['token'], 'SSL');
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['gold_carat'])) {
            $this->data['gold_carat'] = $this->request->post['gold_carat'];
        } elseif (!empty($product_info)) {
            $this->data['gold_carat'] = $product_info['gold_carat'];
        } else {
            $this->data['gold_carat'] = 'gd_24_rate';
        }

        if (isset($this->request->post['gold_weight'])) {
            $this->data['gold_weight'] = $this->request->post['gold_weight'];
        } elseif (!empty($product_info)) {
        ...
        if (isset($this->request->post['diamond_price'])) {
            $this->data['diamond_price'] = $this->request->post['diamond_price'];
        } elseif (!empty($product_info)) {
            $this->data['diamond_price'] = $product_info['diamond_price'];
        } else {
