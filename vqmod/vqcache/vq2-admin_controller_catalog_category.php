	...
	protected function getForm() {
		...
		if (isset($this->request->post['status'])) {
			...
			$this->data['status'] = 1;
                ...
                if (isset($this->request->post['min_manf_charge'])) {
			$this->data['min_manf_charge'] = $this->request->post['min_manf_charge'];
		} elseif (!empty($category_info)) {
			$this->data['min_manf_charge'] = $category_info['man_charge_min'];
		} else {
			$this->data['min_manf_charge'] = 0;
		}
                
                if (isset($this->request->post['manf_charge'])) {
			$this->data['manf_charge'] = $this->request->post['manf_charge'];
		} elseif (!empty($category_info)) {
			$this->data['manf_charge'] = $category_info['man_charge_per'];
		} else {
			$this->data['manf_charge'] = 0;
		}
