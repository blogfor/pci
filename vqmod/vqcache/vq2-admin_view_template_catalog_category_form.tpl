        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
             ...
             <tr>
              <td>Min. Manufacture Charge</td>
              <td><input type="text" value="<?php echo $min_manf_charge;?>" name="min_manf_charge" id="min_manf_charge" /></td>
            </tr>
            
            <tr>
              <td>Manufacture Charge(%)</td>
              <td><input type="text" value="<?php echo $manf_charge;?>" name="manf_charge" id="manf_charge" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-design">
