...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/flat-image/tax.png" alt="" /> <?php echo $heading_title; ?></h1>
        ...
        <table id="tax-rule" class="list">
          ...
          <tbody id="tax-rule-row<?php echo $tax_rule_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#tax-rule-row<?php echo $tax_rule_row; ?>').remove();" class="button delete"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $tax_rule_row++; ?>
          <?php } ?>
...
function addRule() {
	...
	html += '    <td class="left"><a onclick="$(\'#tax-rule-row' + tax_rule_row + '\').remove();" class="button delete"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
