...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/flat-image/product.png" alt="" /> <?php echo $heading_title; ?></h1>
      <div class="buttons"><a onclick="$('#form').submit();" class="button save"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button cancel"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" /><br />
                  ...
                  <a class="upload-image" onclick="image_upload('image', 'thumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Gold (Carat)</td>
              <td><select name="gold_carat">
                
                  <option value="gd_15_rate" <?php if($gold_carat=='gd_15_rate') { echo 'selected="selected"';} ?>>15 Carat</option>
                 <option value="gd_18_rate" <?php if($gold_carat=='gd_18_rate') { echo 'selected="selected"';} ?>>18 Carat</option>
                 <option value="gd_20_rate" <?php if($gold_carat=='gd_20_rate') { echo 'selected="selected"';} ?>>20 Carat</option>
                 <option value="gd_22_rate" <?php if($gold_carat=='gd_22_rate') { echo 'selected="selected"';} ?>>22 Carat</option>
                 <option value="gd_24_rate" <?php if($gold_carat=='gd_24_rate') { echo 'selected="selected"';} ?>>24 Carat</option>
                </select></td>
            </tr>
            <tr>
              <td>Gold (Weight)</td>
              <td><input value="<?php echo $gold_weight;?>" type="text" name="gold_weight" id="gold_weight" /></td>
            </tr>
            <tr>
              <td>Diamond Price</td>
              <td>
        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="button delete"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addAttribute();" class="button insert"><?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="button delete"><?php echo $button_remove; ?></a></td>
                </tr>
              </tbody>
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="left"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="button insert"><?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
        ...
        <div id="tab-profile">
            <table class="list">
                ...
                <tbody>
                    ...
                    <?php foreach ($product_profiles as $product_profile): ?>
                        ...
                        <tr id="profile-row<?php echo $profileCount ?>">
                            ...
                            <td class="left">
                                <a class="button delete" onclick="$('#profile-row<?php echo $profileCount ?>').remove()"><?php echo $button_remove ?></a>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="2"></td>
                        <td class="left"><a onclick="addProfile()" class="button insert"><?php echo $button_add_profile ?></a></td>
                    </tr>
                </tfoot>
            </table>
        </div>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="button delete"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="6"></td>
                <td class="left"><a onclick="addDiscount();" class="button insert"><?php echo $button_add_discount; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="button delete"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="left"><a onclick="addSpecial();" class="button insert"><?php echo $button_add_special; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-image">
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                <td class="left"><div class="image"><img src="<?php echo $product_image['thumb']; ?>" alt="" id="thumb<?php echo $image_row; ?>" />
                    ...
                    <br />
                    <a class="upload-image" onclick="image_upload('image<?php echo $image_row; ?>', 'thumb<?php echo $image_row; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $image_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
                ...
                <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="button delete"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addImage();" class="button insert"><?php echo $button_add_image; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
function addAttribute() {
    ...
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="button delete"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '        <td class="left"><a onclick="addOptionValue(' + option_row + ');" class="button insert"><?php echo $button_add_option_value; ?></a></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="button delete"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addDiscount() {
	...
	html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="button delete"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
function addSpecial() {
	...
	html += '    <td class="left"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="button delete"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
...
function addImage() {
	...
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /><br /><a class="upload-image" onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
	html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" size="2" /></td>';
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="button delete"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addProfile() {
    ...
    html += '  </td>';
    html += '  <td class="left">';
    html += '    <a class="button delete" onclick="$(\'#profile-row' + profileCount + '\').remove()"><?php echo $button_remove ?></a>';
    html += '  </td>';
    html += '</tr>';
