...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/flat-image/setting.png" alt="" /> <?php echo $heading_title; ?></h1>
    ...
    <div class="content">
      ...
      <a href="#tab-special">Gold Price</a>
          ...
          <table class="form">
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $logo; ?>" alt="" id="thumb-logo" />
                  ...
                  <br />
                  <a class="upload-image" onclick="image_upload('logo', 'thumb-logo');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-logo').attr('src', '<?php echo $no_image; ?>'); $('#logo').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $icon; ?>" alt="" id="thumb-icon" />
                  ...
                  <br />
                  <a class="upload-image" onclick="image_upload('icon', 'thumb-icon');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-icon').attr('src', '<?php echo $no_image; ?>'); $('#icon').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
         ...
         <div id="tab-special">
          <table class="form">
            ...
            <tr>
             ...
             <tr>
              <td>Gold Rate 18 Carat</td>
              <td><input type="text" name="gd_18_rate" value="<?php echo $gd_18_rate; ?>" />
                </td>
            </tr>
             <tr>
              <td>Gold Rate 20 Carat</td>
              <td><input type="text" name="gd_20_rate" value="<?php echo $gd_20_rate; ?>" />
                </td>
            </tr>
             <tr>
              <td>Gold Rate 22 Carat</td>
              <td><input type="text" name="gd_22_rate" value="<?php echo $gd_22_rate; ?>" />
                </td>
            </tr>
             <tr>
              <td>Gold Rate 24 Carat</td>
              <td><input type="text" name="gd_24_rate" value="<?php echo $gd_24_rate; ?>" />
                </td>
            </tr>
          </table>
        </div>  
